...
#' @param data Data frame containing, for each study, the effect size estimates of all
#' pathways, also combined ones. This dataframe is returned as an intermediate step of
#' the function \code{\link{fit_meta}}.
#'
#' @return Returns a data frame, that in addition to the meta-data for each study, contains
