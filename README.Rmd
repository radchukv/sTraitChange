...
The goal of sTraitChange is to provide the functions needed to reproduce the analyses for the manuscript 'Changes in phenology mediate vertebrate population responses to temperature globally' by Radchuk et al. *Nature Communications*.
